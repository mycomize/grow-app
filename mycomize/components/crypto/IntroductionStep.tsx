...
export function IntroductionStep({ onCreateSeed, onRecoverData, onSignOut }: IntroductionStepProps) {
  ...
  return (
    <VStack className="flex-1 px-2">
      ...
      <VStack className="flex-1 items-center justify-end pb-8">
        <Button 
          size="lg" 
          variant="outline" 
        ...
        >
          ...
          <ButtonText className="text-lg text-typography-600">Sign Out</ButtonText>
        </Button>
      </VStack>
    </VStack>
  );
